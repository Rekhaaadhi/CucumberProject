...
Scenario: Verify user is able to enter exactly 10charecters to the password textbox
And User should click on the CREATE NEW ACCOUNT link
And User should click on the Register button in siginpage
Then User should be able to enter exactly 10charecters without any error
      |abcdefghij|1234567890|abcd1234e5|bcd@12345|!@#$%^&*()|
 
 
Scenario: Verify user is able to enter exactly 11 charecters to the password textbox
And User should click on the CREATE NEW ACCOUNT link
And User should click on the Register button in siginpage
Then User should be able to enter exactly 11charecters without any error
      |abcdefghijk|12345678901|abcd1234e56|abcd@123456|!@#$%^&*()@|
      
Scenario: Verify user is able to enter exactly 9 charecters to the password textbox
And User should click on the CREATE NEW ACCOUNT link
And User should click on the Register button in siginpage
Then User should be able to enter exactly 9charecters without any error
